...
#fit.sp5 <- nnet1.fit( x, y , 3 , c(25,25) ,  200000 ,  1.5 ,   	Activation = sigmoid, Output = Sigmoid ); #beep("coin")
...
fit.sp1.b <- nnet1.fit.batch( x  , y , 1 , 3 ,  100 , 1500, 3,	Activation = sigmoid, Output = Sigmoid, 32 )
```
