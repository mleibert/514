...
```{r, cache = T}
fit.LG2 <- `( x, y, 1 , 5 , 30000, 1.5, 1.5, Activation = tanh, Output = Identity );  #beep("coin") 
plot(as.vector(y))
...
```{r, cache= T}
fit.sp2 <- nnet1.fit( x, y , 1 , 5 ,  200000 ,  .5 ,  .5 ,	Activation = relu, Output = Sigmoid ); #beep("coin")
```

```{r, cache= T}
fit.sp3 <- nnet1.fit( x, y , 1 , 5 ,  200000 ,  .5 ,  .5 ,	Activation = sigmoid, Output = Sigmoid ); #beep("coin")
```

```{r, cache= T}
#fit.sp4 <- nnet1.fit( x, y , 1 , 100 ,  100000 ,  .5 ,  .5 ,	Activation = tanh, Output = Sigmoid ); #beep("coin")
```


```{r, cache= T}
fit.sp5 <- nnet1.fit( x, y , 1 , 100 ,  200000 ,  .5 ,  .5 ,	Activation = relu, Output = Sigmoid ); #beep("coin")
```

```{r, cache= T}
fit.sp6 <- nnet1.fit( x, y , 1 , 100 ,  200000 ,  .5 ,  .5 ,	Activation = sigmoid, Output = Sigmoid ); #beep("coin")
```
