...
fit.sp1.b <- nnet1.fit.batch( x  , y , 1 , 3 ,  100 , 1500, .8,	Activation = relu, Output = Sigmoid, 32 )
```

```{r batch.sigmoid.2, cache=T }
fit.sp2.b <- nnet1.fit.batch( x  , y , 1 , 3 ,  100 , 1500, .8,	Activation = relu, 
                          Output = Sigmoid, 64 )
```

```{r batch.sigmoid.3, cache=T }
fit.sp3.b <- nnet1.fit.batch( x  , y , 1 , 3 ,  100 , 1500, .8,	Activation = relu, 
                          Output = Sigmoid, 75 )
```
...
```{r jfc,cache=T}
mnist.fit.bat <- nnet1.fit.batch( mx  , my , 1 , Batches = 2000 ,  100 , 10, .15,	 relu,  stable.softmax )
```
...
```{r step13, cache = T}
mnist.fit.5 <- nnet1.fit.batch( mx  , my , 1 , 2000 ,  5 , 10, .15,	Activation = relu, Output = stable.softmax , 32)
```

```{r, cache = T}
mnist.fit.10 <- nnet1.fit.batch( mx  , my , 1 , 2000 ,  10 , 10, .15,	Activation = relu, Output = stable.softmax, 32 )
```

```{r, cache = T}
mnist.fit.30 <- nnet1.fit.batch( mx  , my , 1 , 2000 ,  30 , 10, .15,	Activation = relu, Output = stable.softmax, 32 )
```
