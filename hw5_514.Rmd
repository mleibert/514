...
```{r, cache = T, eval= F}
mnist.fit <- nnet1.fit( x, y, 1 , 5 , 100000,  .15,   relu,  stable.softmax );  
```
...
fit.sig1.b <- nnet1.fit.batch( x  , y , 1 , 3 ,  100 , 1500, 3,	Activation = sigmoid, Output = Sigmoid, 32 )
```

```{r batch.sigmoid.2, cache=T }
fit.sig2.b <- nnet1.fit.batch( x  , y , 1 , 3 ,  100 , 1500, 3,	Activation = sigmoid, Output = Sigmoid, 64 )
```
